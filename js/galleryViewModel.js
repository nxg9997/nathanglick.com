...
function genCards(){
    ...
    projects.push(new project("Detached", "2D Platformer", "Programmer", "./img/detached_thumb.jpg", [new link("Unavailable", "./gallery.html")], "Detached is a 2D platformer where the object of the game is to collect body parts to gain the power to pass through different colored blocks."));
